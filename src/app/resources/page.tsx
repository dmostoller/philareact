...
const resources = [
  ...
  },
  {
    ...
    logoSrc: 'https://imgs.search.brave.com/S05vYKgqxiTYj8fjXx994CzZQJrwxJttMy-B6ys_zNM/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9hc3Nl/dC5icmFuZGZldGNo/LmlvL2lkUFlTUWs2/LVovaWRleGk4N0Vo/Ty5qcGVnP3VwZGF0/ZWQ9MTcwOTQxNjI2/MjM5MQ', // Placeholder for the Frontend Masters logo
  },
  {
    title: 'MDN Web Docs',
    description: 'The best resource for documentation on HTML, CSS, and JavaScript from Mozilla.',
    link: 'https://developer.mozilla.org/',
    logoSrc: 'https://imgs.search.brave.com/_fG2eHXeKsLxlJievxDa6CtV6EFEUT4d76xsaNIHLzI/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9zZWVr/bG9nby5jb20vaW1h/Z2VzL00vbWRuLWxv/Z28tNkRCOUIwMDkz/Ri1zZWVrbG9nby5j/b20ucG5n', // Placeholder for the MDN logo
  },
  {
    title: 'CSS-Tricks',
    description: 'A comprehensive resource for CSS, JavaScript, and front-end development tips.',
    link: 'https://css-tricks.com/',
    logoSrc: 'https://imgs.search.brave.com/Z1REHCWiXhi64tm19feMgJc_E0_RAzvsxwgo_ciUdwQ/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9zdGF0/aWMtMDAuaWNvbmR1/Y2suY29tL2Fzc2V0/cy4wMC9jc3MtdHJp/Y2tzLWljb24tNDc3/eDUxMi1wZmx0cGxt/Zi5wbmc', // Placeholder for the CSS-Tricks logo
  },
  {
    ...
    logoSrc: 'https://imgs.search.brave.com/_Lu2CnhwnGW_UFtNfrHSgapAkMkEvPgBVCX4Cv0z9FI/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9jb3Vy/c2VzLndlc2Jvcy5j/b20vaW1hZ2VzL3dl/c2Jvcy1sb2dvLnBu/Zw', // Placeholder for the Wes Bos logo
  },
  {
    title: 'Egghead.io',
...
export default function ResourcesPage() {
  return (
      <section className="container mx-auto py-12">
        <h1 className="text-4xl font-bold text-center mb-10">React & Front-End Resources</h1>
