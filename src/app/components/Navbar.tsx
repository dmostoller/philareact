    ...
    <nav className="p-4 shadow bg-dark-slate-900">
      <div className="mx-auto w-full flex justify-between items-center">
        ...
        <div className="hidden md:flex align-center space-x-8">
          <Link
            href="/news"
            className="mx-2 text-gray-300 dark:text-gray-300 hover:bg-dark-slate-500 dark:hover:bg-dark-slate-700 hover:rounded-full hover:px-4 py-2 transition-all duration-300 font-semibold"
          >
            Articles
          </Link>
          <Link
        ...
        <div className="hidden md:flex items-center space-x-4">
          {status === 'authenticated' ? (
            <>
              <button
                onClick={() => signOut()}
                className="px-2 button flex items-center  text-gray-300 dark:text-gray-300 hover:bg-dark-slate-500 dark:hover:bg-dark-slate-700 hover:rounded-full hover:px-4 py-2 transition-all duration-300 font-semibold"
              >
